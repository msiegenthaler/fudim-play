...
class MapCube[T](
  ...
  protected override val filters: DimensionFilter = Map.empty) extends AbstractCube[T] {

  protected override type Self = MapCube[T]
...
object MapCube {
  /** An empty MapCube. */
  def apply[T](dimensions: Traversable[Dimension]) = new MapCube[T](dimensions.toSet, Map.empty)
  /**
